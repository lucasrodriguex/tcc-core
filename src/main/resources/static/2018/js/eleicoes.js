var arquivojson="json/eleicoes.json";
...
var color = ["black","gray","limegreen","red","orange","blue","white", "gray", "black"]; // Usado para cores especÃ­ficas.
...
function render(error,mapa) {
		...
		pies.each(function(d,i){
			...
			if(d.eleitorado == null) {
				...
				data = [0,d.Bolsonaro, d.Haddad];
				if (turno==1) data = [0,d.Dilma, d.Aecio, d.Marina, d.outros];
				data.eleitorado = d.Bolsonaro + d.Haddad;
			}
